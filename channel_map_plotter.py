...
def plot_channel_maps(cube, imsize, tick_size, v_sys, sig):
    """Plots 5x5 tiled channel map of line cube, with user specified contour level overplotted.
       Inputs: 1. cube (str): FITS filename, Eg: 'IRAS_07454-7112_100.076392GHz_HC3N_a3.fits'
               2. imsize (int): size (side of square) of channel region to plot (arcseconds), Eg: 25
               3. tick_size (int): interval at which to put axes ticks (arcseconds), Eg: 10
               4. v_sys (float): systemic velocity of the source, Eg: -38.70
               5. sig (int): sigma level at which to plot contour, Eg: 5
               """
